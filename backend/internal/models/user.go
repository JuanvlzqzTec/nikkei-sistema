...
type User struct {
	...
	RegistroEstado  string     `gorm:"default:no_iniciado;size:50;check:registro_estado IN ('no_iniciado','pendiente_revision','completado','rechazado')" json:"registro_estado"`
	MotivoPendiente *string    `gorm:"size:50;check:motivo_pendiente IN ('nuevo_registro','cambio_solicitado')" json:"motivo_pendiente"`
